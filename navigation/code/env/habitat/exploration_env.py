    ...
    def get_short_term_goal(self, inputs):
        ...
        if args.visualize or args.print_images:
            ...
            if args.vis_type == 1: # Visualize predicted map and pose
                ...
                ## Akshaj Commented this line
                vis_grid = np.flipud(vis_grid)
                ##

                ## Please place the TX location here:
                x_y = [<X_TX, Y_TX>] # for example: Adrain map TX-10: x_y = [9.3,20.45] 

                tx_gt = [int((x_y[0]*100/args.map_resolution) - gy1), 240-int((x_y[1]*100/args.map_resolution) - gx1)]
